...
public class StringSchema extends BaseSchema<String> {
    ...
    public final StringSchema required() {
        ...
        super.getNamedPredicate().put(REQUIRED_SCHEMA_NAME, predicate);
        return this;
    }
    ...
    public final StringSchema minLength(int minLength) {
        ...
        super.getNamedPredicate().put(MIN_LENGTH_SCHEMA_NAME, predicate);
    ...
    public final StringSchema contains(String subString) {
        ...
        super.getNamedPredicate().put(CONTAINS_SCHEMA_NAME, predicate);
        return this;
    }
}
